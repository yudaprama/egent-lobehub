...
var COMPOSIO_APP_TYPES = []AppType{
	...
	{AppSlug: "GITHUB", Identifier: "github", Label: "GitHub", Description: "GitHub is a code hosting platform for version control and collaboration", Icon: "https://hub-apac-1.lobeobjects.space/assets/logos/github.svg", Readme: "Integrate with GitHub to manage repositories, issues, and pull requests. List repos, create issues, comment on PRs, search code, and automate your development workflow through natural language.", Author: "Composio", AuthorURL: "https://composio.dev"},
}
